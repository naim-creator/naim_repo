...
public class CustomerService {
    ...
    public BigDecimal getTotalCustomers(UUID id) {
        return customerRepository.findTotalCustomerByCompanyId(id);
    }

    public CustomerResponse getCustomersByCompanyFiltered(UUID id, int page, int size, String filter) {
        Pageable pageable = PageRequest.of(page, size);
        Page<Customer> customers = customerRepository.findByCustomerCompanyIdFiltered(id, filter, pageable);
