...
public class ContactorRequestController {
    ...
    @PutMapping("update")
    public ResponseEntity<String> updateContactorRequest(@RequestBody ContactorRequestDto contactorRequestDto) {
        return this.contactorRequestService.updateContactorRequest(contactorRequestDto);
    }
