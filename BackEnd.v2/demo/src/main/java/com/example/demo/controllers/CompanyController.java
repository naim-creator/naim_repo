...
public class CompanyController {
    ...
    @GetMapping("get/contactor/{id}")
    public CompanyDto getCompanyByContactorId(@PathVariable UUID id) throws Exception {
        return this.companyService.getCompanyByContactorId(id);
    }
